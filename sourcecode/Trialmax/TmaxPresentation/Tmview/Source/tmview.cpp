...
//	01-29-2014	7.27		Added interface methods DoGesturePan() and
//							DoGestureZoom()
//==============================================================================
...
BEGIN_DISPATCH_MAP(CTMViewCtrl, COleControl)
	...
	DISP_FUNCTION_ID(CTMViewCtrl, "DoGestureZoom", dispidDoGestureZoom, DoGestureZoom, VT_EMPTY, VTS_R4 VTS_I4 VTS_I4 VTS_I4 VTS_I4)
	END_DISPATCH_MAP()
...
//
//==============================================================================
void CTMViewCtrl::DoGestureZoom(FLOAT zoomFactor, LONG lX1, LONG lY1, LONG lX2, LONG lY2)
{
	AFX_MANAGE_STATE(AfxGetStaticModuleState());
	...
	//float screenFactor = m_rcMax.right/m_rcMax.bottom;
	...
	if (zoomFactor > 1) {
		/*
		pRect.left = lX - lX*zoomFactor;
		pRect.right = lX;
		pRect.top = lY - lY*zoomFactor;
		pRect.bottom = lY;
		*/
		
		//iWidth  = m_rcMax.right - ((m_rcMax.right/100)*zoomFactor);
		//iHeight = m_rcMax.bottom - ((m_rcMax.bottom/100)*zoomFactor);

		/*
		if (lX1 + iWidth >  m_rcMax.right) {
			//iWidth = m_rcMax.right - lX1;
			iWidth = (iWidth + lX1) % m_rcMax.right;
		}

		if (lY1 + iHeight > m_rcMax.bottom) {
			//iHeight = m_rcMax.bottom - lY1;
			iHeight = (iHeight + lY1) % m_rcMax.bottom;
		}*/
		...
		/*
		pRect.left = lX - lX*zoomFactor;
		pRect.right = lX + m_rcMax.right;
		pRect.top = lY - lY*zoomFactor;
		pRect.bottom = lY + m_rcMax.bottom;
		*/
	...
	GetPane(TMV_ACTIVEPANE)->GestureZoom(zoomFactor, lX1, lY1, lX2, lY2);
