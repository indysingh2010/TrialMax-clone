...
//							defined rectangle
//	01-29-2014	7.27		Added public methods GesturePan() and GestureZoom()
//==============================================================================
...
//
//==============================================================================
void CTMLead::GestureZoom(float zoomFactor, long lX1, long lY1, long lX2, long lY2)
{
	int		iWidth;
	int		iHeight;
    float   DstWidth;
	...
	// we have to convert these points inside lead class.
	/*
	POINT p;
	p.x = lX1;
	p.y = lY1;
	...
	*/
	...
	if (zoomFactor > 1) {
		...
		pCenter.x = (rect.left + rect.right ) / 2;
		pCenter.y = (rect.top + rect.bottom) / 2;
		
	}
	else {
		iWidth  = m_rcMax.right + rect.right + rect.left;
		iHeight = m_rcMax.bottom + rect.bottom + rect.top;
		pCenter.x = (rect.left + rect.right ) / -2;
		pCenter.y = (rect.top + rect.bottom) / -2;	
	}
	*/
