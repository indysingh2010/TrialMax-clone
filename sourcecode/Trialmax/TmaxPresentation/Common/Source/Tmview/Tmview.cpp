...
void CTm_view::DoGestureZoom(float zoomFactor, long lX1, long lY1, long lX2, long lY2)
{
	static BYTE parms[] = VTS_R4 VTS_I4 VTS_I4 VTS_I4 VTS_I4 ;
	InvokeHelper(0x93, DISPATCH_METHOD, VT_EMPTY, NULL, parms, zoomFactor, lX1, lY1, lX2, lY2);
}
